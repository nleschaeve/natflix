            ...
            <div className="absolute inset-0">
                ...
                <div className="relative container mx-auto px-4 h-full flex items-center">
                    <div className="max-w-2xl">
                        ...
                        <span className="bg-primary px-3 py-1 rounded text-sm font-bold">{rating}/10</span>
                        <span className="text-gray-300">{year}</span>
                        <span className="text-gray-300">{duration} min</span>
                        <span className="border border-gray-500 px-2 py-0.5 text-sm rounded">{genre}</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Button size="lg" className="shadow-2xl" onClick={handleRentClick}>
